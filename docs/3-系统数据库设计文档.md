...
user ──M:N── role  (via user_role)
role ──M:N── menu  (via role_menu)

category ──自关联── category (三级树)
category ──M:N── brand  (via category_brand)
